define("hbs!nmodule/bmaps/rc/BMapsWidgetTemplate",["Handlebars"],function(g){var l=g.template({compiler:[7,"\x3e\x3d 4.0.0"],main:function(a,b,c,h,d){return'\x3c!DOCTYPE html\x3e\n\x3chtml lang\x3d"en"\x3e\n\x3chead\x3e\n    \x3cmeta http-equiv\x3d"Content-Type" content\x3d"text/html; charset\x3dutf-8"/\x3e\n    \x3cmeta name\x3d"viewport" content\x3d"initial-scale\x3d1.0, user-scalable\x3dno"/\x3e\n    \x3cstyle type\x3d"text/css"\x3e\n        body, html,#container {\n            width: 100%;\n            height: 100%;\n            overflow: hidden;\n            margin: 0;\n            font-family:sans-serif;\n        }\n    \x3c/style\x3e\n    \x3ctitle\x3e\u5730\u56fe\u5c55\u793a\x3c/title\x3e\n\x3c/head\x3e\n\x3cbody\x3e\n    \n\x3cdiv id\x3d"container"\x3e\x3c/div\x3e\n\x3cdiv id\x3d"search-list" class\x3d"search-list"\x3e\n    \x3cinput type\x3d"text" class\x3d"search" id\x3d"suggestId" size\x3d"20" placeholder\x3d"Search" style\x3d"width:150px;" autocomplete\x3d"off"/\x3e\n    \x3cul class\x3d"list" style\x3d"display: none;" \x3e\x3c/ul\x3e\n\x3c/div\x3e\n\n\x3cdiv style\x3d"display:none;"\x3e\n  \x3c!-- A template element is needed when list is empty, TODO: needs a better solution --\x3e\n  \x3cli id\x3d"search-item"\x3e\n   \x3ch3 class\x3d"title btn"\x3e\x3c/h3\x3e\n  \x3c/li\x3e\n\x3c/div\x3e\n\x3c/body\x3e\n\x3c/html\x3e\n'},
useData:!0});g.registerPartial("nmodule/bmaps/rc/BMapsWidgetTemplate",l);return l});
define("hbs!nmodule/bmaps/rc/PopupTemplate",["Handlebars"],function(g){var l=g.template({compiler:[7,"\x3e\x3d 4.0.0"],main:function(a,b,c,h,d){var e,k;return(null!=(e=c["if"].call(null!=b?b:{},null!=b?b.imgSrc:b,{name:"if",hash:{},fn:a.program(1,d,0),inverse:a.noop,data:d}))?e:"")+(null!=(e=c["if"].call(null!=b?b:{},null!=b?b.description:b,{name:"if",hash:{},fn:a.program(3,d,0),inverse:a.noop,data:d}))?e:"")+'\n  \n  \x3cdiv\x3e\n   \x3ch5 style\x3d"display: inline;"\x3eTotal alarms: '+a.escapeExpression((k=
null!=(k=c.alarmCount||(null!=b?b.alarmCount:b))?k:c.helperMissing,"function"===typeof k?k.call(null!=b?b:{},{name:"alarmCount",hash:{},data:d}):k))+'\x3c/h5\x3e\n  \x3c/div\x3e\n   \n\x3cdiv class\x3d"info-window-props-container"\x3e\n'+(null!=(e=c["if"].call(null!=b?b:{},null!=b?b.rows:b,{name:"if",hash:{},fn:a.program(5,d,0),inverse:a.noop,data:d}))?e:"")+"\x3c/div\x3e\n\x3cbr /\x3e\n\x3cbr /\x3e\n"},1:function(a,b,c,h,d){var e;return"\x3cimg src\x3d"+a.escapeExpression((e=null!=(e=c.imgSrc||(null!=
b?b.imgSrc:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"imgSrc",hash:{},data:d}):e))+" width\x3d'100' height\x3d'100'alt\x3d\"\"\x3e\n"},3:function(a,b,c,h,d){var e;return"\x3cp\x3e"+a.escapeExpression((e=null!=(e=c.description||(null!=b?b.description:b))?e:c.helperMissing,"function"===typeof e?e.call(null!=b?b:{},{name:"description",hash:{},data:d}):e))+"\x3c/p\x3e\n"},5:function(a,b,c,h,d){var e;return null!=(e=c.each.call(null!=b?b:{},null!=b?b.rows:b,{name:"each",hash:{},
fn:a.program(6,d,0),inverse:a.noop,data:d}))?e:""},6:function(a,b,c,h,d){var e,k;return'      \x3cdiv class\x3d"info-window-props-child"\x3e\n        \x3ch5\x3e'+a.escapeExpression((k=null!=(k=c.displayName||(null!=b?b.displayName:b))?k:c.helperMissing,"function"===typeof k?k.call(null!=b?b:{},{name:"displayName",hash:{},data:d}):k))+"\x3c/h5\x3e\n       \x3cspan\x3e "+a.escapeExpression((k=null!=(k=c.value||(null!=b?b.value:b))?k:c.helperMissing,"function"===typeof k?k.call(null!=b?b:{},{name:"value",
hash:{},data:d}):k))+"\x3c/span\x3e\n"+(null!=(e=c["if"].call(null!=b?b:{},null!=b?b.alarm:b,{name:"if",hash:{},fn:a.program(7,d,0),inverse:a.noop,data:d}))?e:"")+"      \x3c/div\x3e\n      \n"},7:function(a,b,c,h,d){return'       \x3cspan class\x3d"alarm-text"\x3e alarm\x3c/span\x3e\n'},useData:!0});g.registerPartial("nmodule/bmaps/rc/PopupTemplate",l);return l});
...
k)})};return function(b){var c=new h(a.listContainer.id,{listClass:b.paginationClass||"pagination",item:"\x3cli\x3e\x3ca class\x3d'page' href\x3d'javascript:function Z(){Z\x3d\"\"}Z()'\x3e\x3c/a\x3e\x3c/li\x3e",valueNames:["page","dotted"],searchClass:"pagination-search-that-is-not-supposed-to-exist",sortClass:"pagination-sort-that-is-not-supposed-to-exist"});a.on("updated",function(){e(c,b)});e(c,b)}}},function(g,l,a){g.exports=function(b){var c=a(2)(b),h=function(a,d){for(var h=0,p=a.length;h<p;h++)b.items.push(new c(d,
a[h]))},d=function(a,c){var q=a.splice(0,50);h(q,c);0<a.length?setTimeout(function(){d(a,c)},1):(b.update(),b.trigger("parseComplete"))};return b.handlers.parseComplete=b.handlers.parseComplete||[],function(){for(var a=b.list.childNodes,c=[],q=0,p=a.length;q<p;q++)void 0===a[q].data&&c.push(a[q]);a=b.valueNames;b.indexAsync?d(c,a):h(c,a)}}},function(g,l){g.exports=function(a){var b,c,h,d,e={resetList:function(){a.i=1;a.templater.clear();d=void 0},setOptions:function(a){2==a.length&&a[1]instanceof
Array?c=a[1]:2==a.length&&"function"==typeof a[1]?(c=void 0,d=a[1]):3==a.length?(c=a[1],d=a[2]):c=void 0},setColumns:function(){0!==a.items.length&&void 0===c&&(c=void 0===a.searchColumns?e.toArray(a.items[0].values()):a.searchColumns)},setSearchString:function(b){b=a.utils.toString(b).toLowerCase();h=b=b.replace(/[-[\]{}()*+?.,\\^$|#]/g,"\\$\x26")},toArray:function(a){var b=[],d;for(d in a)b.push(d);return b}},k={list:function(){for(var b=0,d=a.items.length;b<d;b++)k.item(a.items[b])},item:function(a){a.found=
!1;for(var b=0,d=c.length;b<d;b++)if(k.values(a.values(),c[b]))return void(a.found=!0)},values:function(d,c){return!(!d.hasOwnProperty(c)||!(b=a.utils.toString(d[c]).toLowerCase(),""!==h&&-1<b.search(h)))},reset:function(){a.reset.search();a.searched=!1}},q=function(b){return a.trigger("searchStart"),e.resetList(),e.setSearchString(b),e.setOptions(arguments),e.setColumns(),""===h?k.reset():(a.searched=!0,d?d(h,c):k.list()),a.update(),a.trigger("searchComplete"),a.visibleItems};return a.handlers.searchStart=
a.handlers.searchStart||[],a.handlers.searchComplete=a.handlers.searchComplete||[],a.utils.events.bind(a.utils.getByClass(a.listContainer,a.searchClass),"keyup",function(b){b=b.target||b.srcElement;""===b.value&&!a.searched||q(b.value)}),a.utils.events.bind(a.utils.getByClass(a.listContainer,a.searchClass),"input",function(a){""===(a.target||a.srcElement).value&&q("")}),q}},function(g,l){g.exports=function(a){var b={els:void 0,clear:function(){for(var c=0,d=b.els.length;c<d;c++)a.utils.classes(b.els[c]).remove("asc"),
a.utils.classes(b.els[c]).remove("desc")},getOrder:function(b){var d=a.utils.getAttribute(b,"data-order");return"asc"==d||"desc"==d?d:a.utils.classes(b).has("desc")?"asc":a.utils.classes(b).has("asc")?"desc":"asc"},getInSensitive:function(b,d){"false"===a.utils.getAttribute(b,"data-insensitive")?d.insensitive=!1:d.insensitive=!0},setOrder:function(c){for(var d=0,e=b.els.length;d<e;d++){var k=b.els[d];if(a.utils.getAttribute(k,"data-sort")===c.valueName){var q=a.utils.getAttribute(k,"data-order");
"asc"==q||"desc"==q?q==c.order&&a.utils.classes(k).add(c.order):a.utils.classes(k).add(c.order)}}}},c=function(c,d){a.trigger("sortStart");var e={},k=c.currentTarget||c.srcElement||void 0;k?(e.valueName=a.utils.getAttribute(k,"data-sort"),b.getInSensitive(k,e),e.order=b.getOrder(k)):(e=d||e,e.valueName=c,e.order=e.order||"asc",e.insensitive="undefined"==typeof e.insensitive||e.insensitive);b.clear();b.setOrder(e);var q=e.sortFunction||a.sortFunction||null,g="desc"===e.order?-1:1;a.items.sort(q?function(a,
b){return q(a,b,e)*g}:function(b,d){var c=a.utils.naturalSort;return c.alphabet=a.alphabet||e.alphabet||void 0,!c.alphabet&&e.insensitive&&(c=a.utils.naturalSort.caseInsensitive),c(b.values()[e.valueName],d.values()[e.valueName])*g});a.update();a.trigger("sortComplete")};return a.handlers.sortStart=a.handlers.sortStart||[],a.handlers.sortComplete=a.handlers.sortComplete||[],b.els=a.utils.getByClass(a.listContainer,a.sortClass),a.utils.events.bind(b.els,"click",c),a.on("searchStart",b.clear),a.on("filterStart",
b.clear),c}},function(g,l){var a=function(a){var c,h=this;this.clearSourceItem=function(d,c){for(var k=0,h=c.length;k<h;k++){var g;if(c[k].data){g=0;for(var m=c[k].data.length;g<m;g++)d.setAttribute("data-"+c[k].data[g],"")}else c[k].attr&&c[k].name?(g=a.utils.getByClass(d,c[k].name,!0),g&&g.setAttribute(c[k].attr,"")):(g=a.utils.getByClass(d,c[k],!0),g&&(g.innerHTML=""));g=void 0}return d};this.getItemSource=function(d){if(void 0===d){d=a.list.childNodes;for(var c=0,k=d.length;c<k;c++)if(void 0===
d[c].data)return d[c].cloneNode(!0)}else{if(/<tr[\s>]/g.exec(d))return c=document.createElement("tbody"),c.innerHTML=d,c.firstChild;if(-1!==d.indexOf("\x3c"))return c=document.createElement("div"),c.innerHTML=d,c.firstChild;if(d=document.getElementById(a.item))return d}};this.get=function(c,e){h.create(c);for(var k={},g=0,l=e.length;g<l;g++){var m;if(e[g].data){m=0;for(var r=e[g].data.length;m<r;m++)k[e[g].data[m]]=a.utils.getAttribute(c.elm,"data-"+e[g].data[m])}else e[g].attr&&e[g].name?(m=a.utils.getByClass(c.elm,
e[g].name,!0),k[e[g].name]=m?a.utils.getAttribute(m,e[g].attr):""):(m=a.utils.getByClass(c.elm,e[g],!0),k[e[g]]=m?m.innerHTML:"");m=void 0}return k};this.set=function(c,e){if(!h.create(c))for(var k in e)if(e.hasOwnProperty(k)){var g=e[k],l=void 0,m=void 0;a:{for(var m=0,r=a.valueNames.length;m<r;m++)if(a.valueNames[m].data)for(var t=a.valueNames[m].data,s=0,f=t.length;s<f;s++){if(t[s]===k){m={data:k};break a}}else{if(a.valueNames[m].attr&&a.valueNames[m].name&&a.valueNames[m].name==k){m=a.valueNames[m];
break a}if(a.valueNames[m]===k){m=k;break a}}m=void 0}m&&(m.data?c.elm.setAttribute("data-"+m.data,g):m.attr&&m.name?(l=a.utils.getByClass(c.elm,m.name,!0),l&&l.setAttribute(m.attr,g)):(l=a.utils.getByClass(c.elm,m,!0),l&&(l.innerHTML=g)))}};this.create=function(a){if(void 0!==a.elm)return!1;if(void 0===c)throw Error("The list need to have at list one item on init otherwise you'll have to add a template.");var b=c.cloneNode(!0);return b.removeAttribute("id"),a.elm=b,h.set(a,a.values()),!0};this.remove=
function(c){c.elm.parentNode===a.list&&a.list.removeChild(c.elm)};this.show=function(c){h.create(c);a.list.appendChild(c.elm)};this.hide=function(c){void 0!==c.elm&&c.elm.parentNode===a.list&&a.list.removeChild(c.elm)};this.clear=function(){if(a.list.hasChildNodes())for(;1<=a.list.childNodes.length;)a.list.removeChild(a.list.firstChild)};(c=h.getItemSource(a.item))&&(c=h.clearSourceItem(c,a.valueNames))};g.exports=function(b){return new a(b)}},function(g,l){g.exports=function(a,b){var c=a.getAttribute&&
a.getAttribute(b)||null;if(!c)for(var g=a.attributes.length,d=0;d<g;d++)void 0!==b[d]&&b[d].nodeName===b&&(c=b[d].nodeValue);return c}},function(g,l,a){function b(a){return 48<=a&&57>=a}function c(a,c){for(var g=(a+="").length,h=(c+="").length,l=0,t=0;l<g&&t<h;){var s=a.charCodeAt(l),f=c.charCodeAt(t);if(b(s)){if(!b(f))return s-f;for(;48===s&&++l<g;)s=a.charCodeAt(l);for(;48===f&&++t<h;)f=c.charCodeAt(t);f=l;for(s=t;f<g&&b(a.charCodeAt(f));)++f;for(;s<h&&b(c.charCodeAt(s));)++s;var n=f-l-s+t;if(n)return n;
for(;l<f;)if(n=a.charCodeAt(l++)-c.charCodeAt(t++))return n;l=f;t=s}else{if(s!==f)return s<e&&f<e&&-1!==d[s]&&-1!==d[f]?d[s]-d[f]:s-f;++l;++t}}return g-h}var h,d,e=0;c.caseInsensitive=c.i=function(a,b){return c((""+a).toLowerCase(),(""+b).toLowerCase())};Object.defineProperties(c,{alphabet:{get:function(){return h},set:function(a){h=a;d=[];a=0;if(h)for(;a<h.length;a++)d[h.charCodeAt(a)]=a;e=d.length;for(a=0;a<e;a++)void 0===d[a]&&(d[a]=-1)}}});g.exports=c},function(g,l){g.exports=function(a,b,c){function g(a,
c){var e=a/b.length,f=Math.abs(k-c);return d?e+f/d:f?1:e}var d=c.distance||100,e=c.threshold||0.4;if(b===a)return!0;if(32<b.length)return!1;var k=c.location||0;c=function(){var a,c={};for(a=0;a<b.length;a++)c[b.charAt(a)]=0;for(a=0;a<b.length;a++)c[b.charAt(a)]|=1<<b.length-a-1;return c}();var l=a.indexOf(b,k);-1!=l&&(e=Math.min(g(0,l),e),l=a.lastIndexOf(b,k+b.length),-1!=l&&(e=Math.min(g(0,l),e)));for(var p=1<<b.length-1,l=-1,m,r,t,s=b.length+a.length,f=0;f<b.length;f++){m=0;for(r=s;m<r;)g(f,k+r)<=
e?m=r:s=r,r=Math.floor((s-m)/2+m);s=r;m=Math.max(1,k-r+1);var n=Math.min(k+r,a.length)+b.length;r=Array(n+2);for(r[n+1]=(1<<f)-1;n>=m;n--){var u=c[a.charAt(n-1)];if(0===f?r[n]=(r[n+1]<<1|1)&u:r[n]=(r[n+1]<<1|1)&u|((t[n+1]|t[n])<<1|1)|t[n+1],r[n]&p)if(u=g(f,n-1),u<=e){if(e=u,l=n-1,!(l>k))break;m=Math.max(1,2*k-l)}}if(g(f+1,k)>e)break;t=r}return!(0>l)}}]);define("nmodule/bmaps/rc/dist/list.min",function(){});
...
function(a){p.fine("end")}),setTimeout(t.startViewAnimation(b),0)):t.centerAndZoom(b,18);B();w.attach("changed",z);p.fine("setplace")}function l(){return d.every(E,function(a){return!r(a)})}function q(){var a=l()?s:f;a!=C.getIcon().imageUrl&&(p.fine("update icon"),a=new n.Icon(a,new n.Size(12,20)),C.setIcon(a))}var n=a.$bmaps,t=a.$map,A=m(b.get(g.ComponentTags.idToSlotName("n:geoCoord"))),I=new n.Point(A.lng,A.lat),D=b.getDisplay("title")||b.getDisplayName(),F=new n.Icon(f,new n.Size(12,20)),C=new n.Marker(I,
{icon:F,title:D}),v=new n.InfoWindow,B,w=new g.Subscriber,E,z,G=a.properties().getValue("alwaysSubscribeAllPoints"),F="\x3ca target\x3d'new' href\x3d'javascript:window.top.niagara.env.hyperlink(\""+b.getNavOrd().relativizeToSession().toString()+"\");'\x3e"+D+"\x3c/a\x3e";v.setTitle(F);v.setHeight(600);t.addOverlay(C);a.searchList.add({title:D,pos:A});var J={title:D,pos:A,infoWindow:v};a.points.push(J);a.searchList.list.lastElementChild.addEventListener("click",function(a){e(J)});(function(){return new h(function(c,
d){b.relations().then(function(c){c=c.getAll().filter(function(b){return b.getId().toString()===a.properties().getValue("childRelation")}).map(function(a){return a.getEndpointOrd()});return(new g.BatchResolve(c)).resolve({base:b,subscriber:w})}).then(function(a){E=a.getTargetObjects();c()}).catch(function(a){p.fine("failed: fetchChildren: "+a);d()})})})().then(function(){q();G&&w.attach("changed",d.debounce(q,200))}).catch(function(a){p.fine("failed: update icon "+a)});B=function(){p.fine("updating info window");
var a={ord:b.getNavOrd().relativizeToSession().toString(),displayName:b.getDisplay("title")||b.getDisplayName(),rows:[],alarmCount:0};d.each(E,function(b){var c={displayName:b.getDisplayName(),value:"no data"};r(b)&&(a.alarmCount+=1,c.alarm=!0);if(b=b.getValueOf("out")){b=b.toString();var d=b.indexOf("{");b=b.substring(0,d);c.value=b}a.rows.push(c)});var c=["title","description","imgSrc"];b.getSlots().flags(g.Flags.SUMMARY).each(function(d){var e=b.getDisplayName(d);c.includes(e)?a[e]=b.getDisplay(d):
a.rows.push({displayName:b.getDisplayName(d),value:b.getDisplay(d)||b.get(d)})});v.setContent(k(a));v.isOpen()?v.redraw():t.openInfoWindow(v,I)};z=d.debounce(B,500);C.addEventListener("click",function(){B();w.attach("changed",z)});v.addEventListener("close",function(){w.detach("changed",z);G||w.unsubscribeAll()});v.addEventListener("clickclose",function(){w.detach("changed",z);G||w.unsubscribeAll()})}var s="/module/bmaps/rc/ok.png",f="/module/bmaps/rc/alarm.gif",n=q[0];l=function(){a.apply(this,arguments);
this.properties().add("ak","ZwiEh3WHhKnNRX8Kb9i56NrBBk1VkwDq").add("position","116.404,39.915").add({name:"zoom",value:15,typeSpec:"baja:Integer"}).add("footprint",!1).add({name:"show3D",value:!0,typeSpec:"baja:Boolean",metadata:{trueText:n.get("show3d"),falseText:n.get("hide3d")}}).add("icon","").add("childRelation","m:child").add("alwaysSubscribeAllPoints",!0);b(this)};l.prototype=new a;l.prototype.constructor=l;l.prototype.doInitialize=function(a){var b=this;p.fine("BMapsWidget initializing");
a.addClass("bMapsWidget");a.html(e({}));var d="https://api.map.baidu.com/api?v\x3d3.0\x26ak\x3d"+b.properties().getValue("ak"),f="https://api.map.baidu.com/api?type\x3dwebgl\x26v\x3d1.0\x26ak\x3d"+b.properties().getValue("ak");return new h(function(e,g){require(["async!"+d,"async!"+f],function(){p.fine("Baidu Map API initialized");b.points=[];b.$bmaps=BMapGL;b.$map=new b.$bmaps.Map(a.find("div#container").get(0));var d=m(b.properties().getValue("position")),d=new b.$bmaps.Point(d.lng,d.lat);b.$map.centerAndZoom(d,
b.properties().getValue("zoom"));b.$map.enableScrollWheelZoom(!0);b.$map.addControl(new b.$bmaps.ScaleControl);b.$map.addControl(new b.$bmaps.MapTypeControl);b.$map.addControl(new b.$bmaps.ZoomControl);var f=b.properties().getValue("icon");f&&(f=new b.$bmaps.Icon(f,new b.$bmaps.Size(300,157)),d=new b.$bmaps.Marker(d,{icon:f}),b.$map.addOverlay(d));b.properties().getValue("footprint")&&b.$map.addEventListener("click",function(a){p.info("lng:{},lat:{}",a.point.lng,a.point.lat)});d=new List("search-list",
{item:"search-item",valueNames:["title"]},b.points);b.searchList=d;d.on("updated",function(a){a.matchingItems.length==a.items.length?c(".list").hide():c(".list").show()});e()})})};l.prototype.doLoad=function(a){var b=this;p.fine("BMapsWidget loading");return a.cursor().then(function(a){var b=[];a.each(function(){b.push(this.get())});return b}).then(function(a){return h.all(d.map(a,function(a){return a.tags()}))}).then(function(a){a=d.filter(a,function(a){return a.contains("n:ordInSession")&&a.contains("n:geoCoord")});
