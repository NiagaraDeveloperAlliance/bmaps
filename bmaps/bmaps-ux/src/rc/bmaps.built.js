...
var t = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.imgSrc : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
  ...
  return "      <div class=\"info-window-props-child\">\n        <h3>"
    ...
    return "       <span class=\"alarm-text\"> alarm</span>\n";
},"useData":true});
...
define('nmodule/bmaps/rc/BMapsWidget',[
  ...
  'css!nmodule/bmaps/rc/dist/bootstrap.min',
], function (
  baja,
  types,
  Widget,
  ...
  BMapsWidget.prototype.doLoad = function (table) {
    ...
    return table
      ...
      .then(function (batchResolve) {
        ...
        document.querySelectorAll('h3.title').forEach(function (item) {});
      });
  };
